...
class Editing {
  ...
  update() {
    ...
    this.api.postPatch(this.branch.active.id, JSON.stringify(geojson))
      ...
      .finally(() => {
        ...
        this.controllers.changeColor('polygon', '');
      });
  }
  ...
  keydown(e) {
    ...
    if (this.currentStatus === status.RAS) {
      ...
      if (this.opiName !== 'none' && (e.key === 'Escape')) {
        ...
        this.controllers.changeColor('opiName', '');
    ...
    if (e.key === 'Escape') {
      if (this.currentStatus === status.SELECT) {
        ...
        this.controllers.changeColor('select', '');
      }
      ...
      if (this.currentStatus === status.ADDREMARK) {
        ...
        this.controllers.changeColor('addRemark', '');
      }
      this.viewer.message = '';
      this.view.controls.setCursor('default', 'auto');
      this.currentStatus = status.RAS;
      ...
      case status.SELECT: {
        ...
        this.api.getGraph(this.branch.active.id, mousePosition)
          .then((opi) => {
            ...
            this.controllers.changeColor('opiName', `rgb(${this.color[0]},${this.color[1]},${this.color[2]})`);
  ...
  select() {
    ...
    this.controllers.changeColor('select', '#BB0000');
  }
  ...
  polygon() {
    ...
    this.controllers.changeColor('polygon', '#BB0000');
  ...
  addRemark() {
    ...
    this.controllers.changeColor('addRemark', '#BB0000');
  }
