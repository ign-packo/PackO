...
--
-- Name: auto_num_vectors(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.auto_num_vectors() RETURNS trigger
    LANGUAGE plpgsql
    AS $$BEGIN
	NEW.num = (
		SELECT  
...
ALTER FUNCTION public.auto_num_vectors() OWNER TO postgres;
...
ALTER TABLE public.vectors ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: vectors vectors_name_id_branch_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.vectors
    ADD CONSTRAINT vectors_name_id_branch_key UNIQUE (name, id_branch);


--
-- Name: vectors vectors_num_id_branch_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.vectors
    ADD CONSTRAINT vectors_num_id_branch_key UNIQUE (num, id_branch);
...
--
-- Name: patches auto_num_vectors; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER auto_num_vectors BEFORE INSERT ON public.vectors FOR EACH ROW EXECUTE FUNCTION public.auto_num_vectors();
...
--
-- Name: vectors vectors_id_branch_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.vectors
    ADD CONSTRAINT vectors_id_branch_fkey FOREIGN KEY (id_branch) REFERENCES public.branches(id) ON DELETE CASCADE NOT VALID;


--
-- Name: vectors vectors_id_style_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.vectors
    ADD CONSTRAINT vectors_id_style_fkey FOREIGN KEY (id_style) REFERENCES public.style(id) NOT VALID;
