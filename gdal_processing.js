...
// function processPatch(patch, blocSize) {
//   // On patch le graph
//   const { mask } = patch;
...
//   debug(patch);
//   const dsGraph = gdal.open(patch.urlGraph);
//   const dsOpi = gdal.open(patch.urlOpi);
//   const dsOrtho = gdal.open(patch.urlOrtho);
//   {
//     debug('chargement...');

//     const bands = [
//       dsGraph.bands.get(1).pixels.read(0, 0, dsGraph.rasterSize.x, dsGraph.rasterSize.y),
//       dsGraph.bands.get(2).pixels.read(0, 0, dsGraph.rasterSize.x, dsGraph.rasterSize.y),
//       dsGraph.bands.get(3).pixels.read(0, 0, dsGraph.rasterSize.x, dsGraph.rasterSize.y),
//       dsOpi.bands.get(1).pixels.read(0, 0, dsGraph.rasterSize.x, dsGraph.rasterSize.y),
//       dsOpi.bands.get(2).pixels.read(0, 0, dsGraph.rasterSize.x, dsGraph.rasterSize.y),
//       dsOpi.bands.get(3).pixels.read(0, 0, dsGraph.rasterSize.x, dsGraph.rasterSize.y),
//       dsOrtho.bands.get(1).pixels.read(0, 0, dsGraph.rasterSize.x, dsGraph.rasterSize.y),
//       dsOrtho.bands.get(2).pixels.read(0, 0, dsGraph.rasterSize.x, dsGraph.rasterSize.y),
//       dsOrtho.bands.get(3).pixels.read(0, 0, dsGraph.rasterSize.x, dsGraph.rasterSize.y),
//     ];
//     {
...
//       debug('creation des images en memeoire...');
//       const graphMem = gdal.open('graph', 'w', 'MEM',
// dsGraph.rasterSize.x, dsGraph.rasterSize.y, 3);
...
//       const orthoMem = gdal.open('ortho', 'w', 'MEM',
// dsGraph.rasterSize.x, dsGraph.rasterSize.y, 3);
//       orthoMem.bands.get(1).pixels.write(0, 0,
//         dsGraph.rasterSize.x, dsGraph.rasterSize.y, bands[6]);
//       orthoMem.bands.get(2).pixels.write(0, 0,
//         dsGraph.rasterSize.x, dsGraph.rasterSize.y, bands[7]);
//       orthoMem.bands.get(3).pixels.write(0, 0,
//         dsGraph.rasterSize.x, dsGraph.rasterSize.y, bands[8]);
//       debug('... fin creation des images en memoire');
//       debug('creation des COGs ...');

//       gdal.drivers.get('COG').createCopy(patch.urlGraphOutput, graphMem, {
//         BLOCKSIZE: blocSize,
//         COMPRESS: 'LZW',
//       });
//       gdal.drivers.get('COG').createCopy(patch.urlOrthoOutput, orthoMem, {
//         BLOCKSIZE: blocSize,
//         COMPRESS: 'JPEG',
//         QUALITY: 90,
//       });
